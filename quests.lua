...
-- Без term.setBackground, только term.clear, setCursor, setForeground
-- Для OpenComputers (McSkill 1.7.10)
-- ============================================================================
...
-- Функция рисования рамки (только границы, без заливки)
...
while true do
    ...
    if ev[1] == "touch" then
        ...
        -- Сюда можно добавить обработку других кнопок (анимация нажатия)
    end
end
