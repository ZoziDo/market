...
-- Цветовая схема
local colors = {
    bg_main        = 0x050505,   -- главный фон
    bg_secondary   = 0x121212,   -- вторичный фон (панели, строки)
    bg_button      = 0x1F1F1F,   -- кнопки, заголовки
    accent_main    = 0x00A2C9,   -- главный акцент (активные элементы)
    accent_secondary = 0xE68A4E, -- вторичный акцент (цены, выделения)
    text_main      = 0xD0D0D0,   -- основной текст
    text_bright    = 0xF0F0F0,   -- яркий текст (заголовки)
    success        = 0x00B88A,   -- успех
    error          = 0xE05C5C,   -- ошибка
    inactive       = 0x444444    -- неактивно
}
