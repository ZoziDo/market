...
local function drawDebug(text)
  ...
  gpu.set(1, 25, string.format("%-79s", text))  -- затираем всю строку
end
...
local function drawMainMenu()
  clear()
  drawDebug("Главное меню. Игрок: " .. (currentPlayer or "нет"))
...
while true do
    ...
    if from == serverAddress then
      ...
      if success and msg then
        if msg.op == "welcome" then
          ...
          print("✅ Терминал зарегистрирован")
  ...
  -- Обновляем отладочную строку, если текущий экран не рисует её (например, welcome)
  if currentScreen == "welcome" then
    drawDebug("Ожидание игрока...")
  end
end
